...
class GA:
	...
	def __init__(self, population_size = 100, max_generation = 50, elitism_size = 1, metrics = ["Kappa", "F2", "AUC"], 
				verbose = True):
	...
	def fit(self,Tr_X, Tr_Y, Te_X = None, Te_Y = None):
		...
		self.population = Population_GA(Tr_X, Tr_Y, Te_X, Te_Y, self.population_size, self.max_generation, self.elitism_size, self.metrics)
